...
const double omega_max = 1.5; //1 rad/sec
...
private:
    ...
    bool appendPathQueueCB(amcl_control::pathRequest& request,amcl_control::pathResponse& response);
