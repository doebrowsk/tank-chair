/*
 * FPGA Interface C API 1.2 header file.
 *
 * Copyright (c) 2010,
...
/**
 * The number of elements to read or write must be less than or equal to the
 * depth of the host memory DMA FIFO.
 */
static const NiFpga_Status NiFpga_Status_BadReadWriteCount = -61703;
 ...
 *
 * @param session handle to a currently open session
 * @param fifo the peer-to-peer reader FIFO
