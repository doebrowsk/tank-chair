...
const double R_LEFT_WHEEL = 0.382;
const double R_RIGHT_WHEEL = 0.382; //introduce error--tire diam diff
//from URDF: <xacro:property name="track" value=".56515" />
const double TRACK = 0.78; //0.56515; //0.560; // track error
...
int main(int argc, char **argv) {
    ...
    g_drifty_odom.header.frame_id = "odom";
    g_drifty_odom.header.stamp = g_cur_time;
    ...
    g_drifty_odom_pub = nh.advertise<nav_msgs::Odometry>("odom", 1);
